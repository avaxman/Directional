...
namespace directional
{
    ...
    //  width:  Width of the seam lines
    //  res:    Resolution of the cylinder bases.
    // Output:
    //  VSeams: Vertices of the seam cylinders.
    //  FSeams: Faces of the seam cylinders.
    //  CSeams: Colors of the seam cylinders (per face).
